...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore UV0S
// UVS0
Vector4[] src_uv0s = m_cachedMeshInfoVertexData[materialIndex].uvs0; // This is Vector4[]
Vector4[] dst_uv0s = new Vector4[src_uv0s.Length]; // Create a new Vector2[] array

// Populate the dst_uv0s array
for (int j = 0; j < src_uv0s.Length; j++)
{
    dst_uv0s[j] = src_uv0s[j]; //new Vector2(src_uv0s[j].x, src_uv0s[j].y); // Extract x and y from Vector4
}

// Now you can use dst_uv0s as needed
