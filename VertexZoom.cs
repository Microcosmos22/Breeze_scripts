        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    print(cachedMeshInfoVertexData.GetType());
                    
                    
                    
                    
                    
                    // Assume cachedMeshInfoVertexData[materialIndex].uvs0 is of type Vector4[]
                    Vector4[] sourceUVs0 = cachedMeshInfoVertexData[materialIndex].uvs0; // Ensure this is Vector4[]
                    Vector2[] destinationUVs0 = new Vector2[sourceUVs0.Length];

                    for (int j = 0; j < sourceUVs0.Length; j++)
                    {
                        // Extract x and y from Vector4 to create Vector2
...
// Assuming uvs0 is an array of Vector4
Vector4[] sourceUVs0 = textInfo.meshInfo[i].uvs0;

// Create a new Vector2 array for the UVs
Vector2[] newUVs = new Vector2[sourceUVs0.Length];

// Populate the new Vector2 array
for (int j = 0; j < sourceUVs0.Length; j++)
{
    newUVs[j] = new Vector2(sourceUVs0[j].x, sourceUVs0[j].y);
}
...
textInfo.meshInfo[i].mesh.colors32 = textInfo.meshInfo[i].colors32;
                    ...
                    // Updated modified vertex attributes
                    //textInfo.meshInfo[i].mesh.vertices = textInfo.meshInfo[i].vertices;
                    //textInfo.meshInfo[i].mesh.uv = new Vector2(textInfo.meshInfo[i].uvs0[0], textInfo.meshInfo[i].uvs0[1]);
                    //textInfo.meshInfo[i].mesh.colors32 = textInfo.meshInfo[i].colors32;
